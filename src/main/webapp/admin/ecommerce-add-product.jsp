            ...
            <div class="js-add-field" data-hs-add-field-options='{
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="color" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                </div><br>
                <!-- Screen size -->
                <div class="input-group">
                  <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control" id="screenSize" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                  <div class="input-group-append">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="ssd" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                </div><br>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text" >Battery</span>
                  </div>
                  <input type="text" class="form-control" id="battery" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="os" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="vga" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="cpu" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="gpu" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="ram" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="withPrependLabel" placeholder="Type here" aria-label="Username" aria-describedby="basic-addon1">
      ...
      <div class="col-lg-4">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <label for="promotionPercent" class="input-label">Promotion Percent</label>
            <input type="text" class="js-tagify tagify-form-control form-control" name="tagsName" id="promotionPercent" placeholder="Enter promotion percent here" aria-label="Enter promotion percent here"><br>
            <label for="quantity" class="input-label">Quantity</label>
            <input type="text" class="js-tagify tagify-form-control form-control" name="tagsName" id="quantity" placeholder="Enter quantity here" aria-label="Enter quantity here">
          </div>
          <!-- End Body -->
        </div>
        <!-- End Card -->
