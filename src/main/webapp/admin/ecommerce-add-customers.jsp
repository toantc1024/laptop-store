...
<head>
  ...
  <!-- Title -->
  <title>Checkout - E-commerce | Front - Admin &amp; Dashboard Template</title>
  ...
  <div class="content container-fluid">
    ...
    <form class="js-step-form" data-hs-step-form-options='{
      ...
      <div class="w-md-75 mx-md-auto">
        <!-- Step -->
        <ul id="checkoutStepFormProgress" class="js-step-progress step step-sm step-icon-sm step-inline step-item-between mb-7">
          <li class="step-item">
              ...
              <div class="card-body">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <div class="text-body font-size-sm">
                      <span>Color:</span>
                      <span class="text-dark font-weight-bold">Green</span>
                    </div>
                    <div class="text-body font-size-sm">
                      <span>Size:</span>
                      <span class="text-dark font-weight-bold">UK 7</span>
                    </div>
                  </div>
                </div>
                <!-- End Media -->
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <div class="text-body font-size-sm">
                      <span>Size:</span>
                      <span class="text-dark font-weight-bold">M</span>
                    </div>
                  </div>
                </div>
                <!-- End Media -->
                ...
                <div class="row align-items-center mb-3">
                  ...
                  <h4 class="col-6 text-right text-dark mb-0">$199.00</h4>
                </div>
                <!-- End Row -->
                ...
                <div class="row align-items-center">
                  ...
                  <h4 class="col-6 text-right text-dark mb-0">$20.00</h4>
                </div>
                <!-- End Row -->
                ...
                <div class="row align-items-center">
                  <span class="col-6 text-dark font-weight-bold">Total to pay:</span>
                  <h3 class="col-6 text-right text-dark mb-0">$219.00</h3>
                </div>
                <!-- End Row -->
              </div>
              <!-- Body -->
            ...
            <div id="checkoutStepDelivery" class="active">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="firstNameDeliveryAddressLabel" class="input-label">First name</label>
                    ...
                    <div class="col-sm-6">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="lastNameDeliveryAddressLabel" class="input-label">Last name</label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="emailDeliveryAddressLabel" class="input-label">Email</label>
                    ...
                    <div class="col-sm-6">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="phoneDeliveryLabel" class="input-label">Phone</label>
                        <input type="text" class="js-masked-input form-control" name="phoneDeliveryName" id="phoneDeliveryLabel" placeholder="+x(xxx)xxx-xx-xx" aria-label="+x(xxx)xxx-xx-xx" data-hs-mask-options='{
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="deliveryStreetAddressLabel" class="input-label">Street address</label>
                    ...
                    <div class="col-sm-4">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="deliveryUnitLabel" class="input-label">Unit</label>
                  ...
                  <!-- Form Group -->
                  <div class="form-group">
                    <label for="deliveryCityLabel" class="input-label">City</label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- Select -->
                      <div class="form-group">
                        <label for="billingCountryLabel" class="input-label">Country</label>

                        <select class="js-select2-custom custom-select" size="1" style="opacity: 0;" id="billingCountryLabel" data-hs-select2-options='{
                    ...
                    <div class="col-sm-6">
                      <!-- Form Group -->
                      <div class="form-group">
                        <label for="DeliveryZipCodeLabel" class="input-label">Zip code <i class="tio-help-outlined text-body ml-1" data-toggle="tooltip" data-placement="top" title="You can find your code in a postal address."></i></label>

                        <input type="text" class="js-masked-input form-control" name="DeliveryZipCode" id="DeliveryZipCodeLabel" placeholder="SE7 5QY" aria-label="SE7 5QY" data-hs-mask-options='{
                                     "template": "AA0 0AA"
                                   }'>
                      </div>
                      <!-- End Form Group -->
                  ...
                  <div class="custom-control custom-checkbox form-group">
                    <input type="checkbox" class="custom-control-input" id="exclusiveOffersCardCheckbox1">
                    <label class="custom-control-label" for="exclusiveOffersCardCheckbox1">Please send me emails with exclusive offers</label>
                  </div>
                  <!-- End Custom Checkbox -->
                </div>
                <!-- Body -->
              ...
              <div class="card mb-3 mb-lg-5">
                ...
                <div class="card-body">
                  ...
                  <div class="custom-control custom-radio mb-3">
                    <input type="radio" id="deliveryOptionCheckbox1" name="deliveryOptionCheckbox" class="custom-control-input" checked="">
                    <label class="custom-control-label" for="deliveryOptionCheckbox1">
                      <span class="d-block font-weight-bold mb-1">Standard Delivery</span>
                  ...
                  <div class="custom-control custom-radio">
                    <input type="radio" id="deliveryOptionCheckbox2" name="deliveryOptionCheckbox" class="custom-control-input">
                    <label class="custom-control-label" for="deliveryOptionCheckbox2">
                      <span class="d-block font-weight-bold mb-1">$9.99 - Next-day delivery</span>
              ...
              <div class="d-flex align-items-center">
                <a class="btn btn-ghost-secondary" href="#">
                  <i class="tio-chevron-left"></i> Return to Cart
                </a>
                <div class="ml-auto">
                  <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                                "targetSelector": "#checkoutStepPayment"
                              }'>
                    Continue <i class="tio-chevron-right"></i>
                  </button>
                </div>
              </div>
              <!-- End Footer -->
            ...
            <div id="checkoutStepPayment" style="display: none;">
              ...
              <div class="d-flex align-items-center">
                <button type="button" class="btn btn-ghost-secondary" data-hs-step-form-next-options='{
                  ...
                  <i class="tio-chevron-left"></i> Return to Delivery
                </button>
                <div class="ml-auto">
                  <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{
                                "targetSelector": "#checkoutStepSummary"
            ...
            <div id="checkoutStepSummary" style="display: none;">
              ...
              <div class="d-flex align-items-center">
                <button type="button" class="btn btn-ghost-secondary" data-hs-step-form-next-options='{
                  ...
                  <i class="tio-chevron-left"></i> Return to Payment
                </button>
                <div class="ml-auto">
    ...
    <div id="checkoutStepSuccessMessage" style="display: none;">
      <div class="text-center">
        ...
        <a class="btn btn-primary" href="ecommerce.html">
          <i class="tio-shopping-basket-outlined mr-1"></i> Continue shopping
        </a>
      </div>
    </div>
    <!-- End Message Body -->
